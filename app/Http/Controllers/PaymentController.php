...
class PaymentController extends Controller
{
	...
	public function avigher_showpage(Request $request) {
		 $datas = $request->all();
	...
	$userphone = $datas['userphone'];
	   ...
	   $userdetails = DB::table('users')
		 ...
		 $mojoname = $userdetails[0]->name;
		 $mojoemail = $userdetails[0]->email;
		 $mojophone = $userdetails[0]->phone;
...
$booking = DB::table('booking')
	...
	/* end seller email */	
	  ...
	  'paypal_url' => $paypal_url, 'booking_id' => $booking_id, 'payment_mode' => $payment_mode, 'mojoname' => $mojoname, 'mojoemail' => $mojoemail, 'mojophone' => $mojophone);

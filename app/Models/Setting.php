...
class Setting extends Model
{
    ...
    {
        return [
            "Access Bank", "Citibank", "Diamond Bank", "Ecobank", "Fidelity Bank", "First Bank of Nigeria (FBN)", "First City Monument Bank (FCMB)", "Guaranty Trust Bank (GTBank)", "Heritage Bank", "Keystone Bank", "Skye Bank", "Stanbic IBTC Bank", "Sterling Bank", "Union Bank", "United Bank for Africa", "Unity Bank", "Wema Bank", "Zenith Bank",
        ];
    }
    ...
    {
        return [
            "Bank Deposit", "ATM Transfer", "Quickteller", "Mobile App Transfer", "Internet Banking", "USSD Mobile Transfer", "Bank Counter Transfer",
        ];
    }
    ...
    {
        return [
            'Abuja FCT', 'Abia State', 'Adamawa State', 'Akwa Ibom State',

...
class Subscribed extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                ...
                ->line('You have successfully subscribed to notifications from '.Setting::get('domain_name'))
                ->line('We will notify you of new Sermons for downloads, Upcoming Events and Life News Articles.')

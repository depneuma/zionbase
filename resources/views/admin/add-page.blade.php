	...
	@endif
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <textarea id="txtDefaultHtmlArea<?php echo $languagee->id;?>" class="form-control col-md-7 col-xs-12" required="required" name="page_desc[]"></textarea>      
					   </div>
                      </div>
            ...
            $("#txtDefaultHtmlArea<?php echo $languagee->id;?>").htmlarea(); 
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <input type="checkbox" class="" name="top_menu" value="1" style="margin-top:13px; padding:4px; cursor:pointer;">
					   </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <input type="checkbox" class="" name="footer_menu" value="1" style="margin-top:13px; padding:4px; cursor:pointer;">
					   </div>
                      </div>

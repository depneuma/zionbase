...
<?php  if (in_array(14, $hidden)){?>
	...
	@endif
                   ...
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.add-staff-type') }}" enctype="multipart/form-data" novalidate>
                     {{ csrf_field() }}  
                      <span class="section">Add Staff Type</span>

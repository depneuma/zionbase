		 ...
		 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="">
                 ...
                 {{ csrf_field() }}
				  ...
				  <?php } else { ?>
				  <a href="<?php echo $url;?>/admin/add_category" class="btn btn-primary">Add Category</a>
				  <?php } ?>
          ...
          <span class="sub"></span> Select All </button></th>
					  ...
					  foreach ($category as $categories) { ?>
                        ...
                        <tr>
                        <td><input type="checkbox" name="category_id[]" value="<?php echo $categories->gid;?>"/></td>
				  ...
				  <?php } else { ?>
						  <a href="<?php echo $url;?>/admin/edit_category/{{ $categories->gid }}" class="btn btn-success">Edit</a>
						  <?php } ?>
				   <?php if(config('global.demosite')=="yes"){?>
				   <a href="#" class="btn btn-danger btndisable">Delete</a>  <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span>
				  <?php } else { ?>
						 <a href="<?php echo $url;?>/admin/category/{{ $categories->gid }}" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this?')">Delete</a>

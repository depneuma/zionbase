...
<?php  if (in_array(14, $hidden)){?>
	...
	@endif
                   ...
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.edit-staff-type') }}" enctype="multipart/form-data" novalidate>
                     {{ csrf_field() }}  
                      <span class="section">Edit Staff Type</span>

                      <?php /* ?><div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12"  name="name" value="<?php echo $stafftype[0]->name; ?>" required="required" type="text">
						  @if ($errors->has('name'))
                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
					  ...
					  if($languagee->lang_code=="en")
					  {
						  ...
						  $count_en = DB::table('staff_type')
										->where('parent', '=', 0)
										->where('id', '=', $stafftype[0]->id)
										
										->count();
						  if(!empty($count_en))
						  {
						  $view = DB::table('staff_type')
										->where('parent', '=', 0)
										->where('id', '=', $stafftype[0]->id)
					  ...
					  {
					      $count_other = DB::table('staff_type')
										->where('parent', '=', $stafftype[0]->id)
					  ...
					  <input type="hidden" name="currentphoto" value="<?php echo $stafftype[0]->image;?>">
                     
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <a href="<?php echo $url;?>/admin/staff-type" class="btn btn-primary">Cancel</a>

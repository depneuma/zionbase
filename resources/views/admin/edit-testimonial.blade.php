                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
					  ...
					  if($languagee->lang_code=="en")
					  {
						  ...
						  $count_en = DB::table('testimonials')
										->where('parent', '=', 0)
										->where('id', '=', $testimonials[0]->id)
										
										->count();
						  if(!empty($count_en))
						  {
						  $view = DB::table('testimonials')
										->where('parent', '=', 0)
										->where('id', '=', $testimonials[0]->id)
					  ...
					  {
					      $count_other = DB::table('testimonials')
										->where('parent', '=', $testimonials[0]->id)
                     ...
                     <div class="item form-group">
                        ...
                        <textarea id="desc[]" class="form-control col-md-7 col-xs-12" required="required" name="desc[]"><?php echo $viewdesc; ?></textarea>
					   </div>
                      </div>

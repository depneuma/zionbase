...
<?php  if (in_array(6, $hidden)){?>
	...
	@endif
                   ...
                   <form class="form-horizontal form-label-left" role="form" method="POST" action="{{ route('admin.edit_category') }}" enctype="multipart/form-data" novalidate>
                     {{ csrf_field() }}  
                  ...
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
					  ...
					  ?>
                        ...
                        <input type="hidden" name="id" value="<?php echo $category[0]->gid; ?>">

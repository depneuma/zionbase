        ...
        <div class="right_col" role="main">
		 ...
		 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <?php if(config('global.demosite')=="yes"){?>
				  <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span> <a href="#" class="btn btn-primary btndisable">Add Event</a> 
				  <?php } else { ?>
				  <a href="<?php echo $url;?>/admin/add-event" class="btn btn-primary">Add Event</a>
				  <?php } ?>
                  <div class="x_content">
          ...
          <span class="sub"></span> Select All </button></th>
					  ...
					  $post_comment = DB::table('post')
							 ->where('post_parent', '=', $event->post_id)
					...
					$active_comment = DB::table('post')
					  ...
					  ?>
                        ...
                        <td><input type="checkbox" name="even_id[]" value="<?php echo $event->post_id;?>"/></td>
						 ...
						 <td><?php echo $i;?></td>
                          ...
                          <td> <?php echo $event->post_seat_space;?> </td>
                          
                          
                          
                          <td> <a href="<?php echo $url;?>/admin/comment/event/comment/<?php echo $event->post_id;?>" style="color:#067DE3; text-decoration:underline;"><?php echo $post_comment;?> Comment</a> 
						...
						$path ='/local/images/post/'.$event->post_image;
						if($event->post_media_type=="image"){
						   if($event->post_image!=""){
						?>
				  ...
				  <?php } else { ?>
						  ...
						  <a href="<?php echo $url;?>/admin/edit-event/{{ $event->post_id }}" class="btn btn-success">Edit</a>
						  <?php } ?>
				   <?php if(config('global.demosite')=="yes"){?>
				    <a href="#" class="btn btn-danger btndisable">Delete</a>  <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span>
				  <?php } else { ?>
						 <a href="<?php echo $url;?>/admin/events/{{ $event->post_id }}" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this?')">Delete</a>
						  <?php } ?>
						  </td>
                        </tr>
                        <?php $i++;} ?>

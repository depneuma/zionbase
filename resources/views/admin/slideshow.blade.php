        ...
        <div class="right_col" role="main">
		 ...
		 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <?php } else { ?>
				  <a href="<?php echo $url;?>/admin/add-slideshow" class="btn btn-primary">Add Image</a>
				  <?php } ?>
                  <div class="x_content">
          ...
          <span class="sub"></span> Select All </button></th>
					  ...
					  foreach ($slideshow as $slide) { ?>
                        ...
                        <tr>
                         <td><input type="checkbox" name="slider_id[]" value="<?php echo $slide->id;?>"/></td>
						 <td><?php echo $i;?></td>
						 <?php 
					   $photo="/post/";
						$path ='/local/images'.$photo.$slide->slide_image;
				  ...
				  <?php } else { ?>
						  ...
						  <a href="<?php echo $url;?>/admin/edit-slideshow/{{ $slide->id }}" class="btn btn-success">Edit</a>
						  <?php } ?>
				   <?php if(config('global.demosite')=="yes"){?>
				    <a href="#" class="btn btn-danger btndisable">Delete</a>  <span class="disabletxt">( <?php echo config('global.demotxt');?> )</span>
				  <?php } else { ?>
						 <a href="<?php echo $url;?>/admin/slideshow/{{ $slide->id }}" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete this?')">Delete</a>
						  <?php } ?>
						  </td>
                        </tr>
                        <?php $i++;} ?>

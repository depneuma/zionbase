...
<body>
	...
	<div class="container">
	 <h1><?php echo $site_name;?> - Event Booking Received</h1>
    ...
    <div style="background:#B98B4B;padding:15px 10px 10px 10px;">
			...
			<h3>Event Booking Received</h3>
			<p> Event Name - <a href="<?php echo $url;?>/events/<?php echo $event_slug;?>"><?php echo $event_title;?></a></p>
            <br/>
            
            <h3>Booking Details</h3>
            
			<p> Name - <?php echo $booking_name;?></p> 	
			<p> Email - <?php echo $booking_email;?></p> 	
			<p> Phone No - <?php echo $booking_phone;?></p> 	
			<p> Message - <?php echo $booking_message;?></p> 	
			<p> Need Seats - <?php echo $booking_seats;?></p> 	

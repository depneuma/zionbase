                ...
                <div class="col-md-6 py-4 py-md-5 ftco-animate d-flex align-items-center">
                    <div class="text p-md-5">
                        ...
                        <p class="mt-4 btn-customize">
                            @if ($sermon->video)
                            <a href="{{ $sermon->video ? $sermon->video : '#' }}" class="btn btn-primary px-4 py-3 mr-md-2 popup-vimeo"><span
                                    class="fa fa-play"></span> Watch Video</a> 
                            @endif
                            <a href="{{ \Storage::url($sermon->audio) }}" class="btn btn-primary btn-outline-primary px-4 py-3 ml-lg-2"><span

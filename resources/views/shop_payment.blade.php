...
@include('static')
    ...
    <?php if($payment_type=="cash-on-delivery"){?>
     <form class="form-horizontal" role="form" method="POST" action="{{ route('cash-on-delivery') }}" id="formID" enctype="multipart/form-data">
                        {{ csrf_field() }}
...
$hash_string = $merchant."|".$txnid."|".$amount."|".$product_names."|".$name."|".$email."|||||||||||".$salt;
$hash = strtolower(hash('sha512', $hash_string));
    ...
    <input type="hidden" name="productinfo" value="<?php echo $product_names; ?>">
